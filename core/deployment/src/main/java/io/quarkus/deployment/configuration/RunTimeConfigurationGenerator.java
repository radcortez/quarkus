...
import io.quarkus.runtime.QuarkusRuntimeConfigSource;
...
public final class RunTimeConfigurationGenerator {
    ...
    public static final MethodDescriptor C_CREATE_RUN_TIME_CONFIG = MethodDescriptor.ofMethod(CONFIG_CLASS_NAME,
            "createRunTimeConfig", void.class, QuarkusRuntime.class);
    ...
    public static final class GenerateOperation implements AutoCloseable {
        ...
        public void run() {
            ...
            ResultHandle quarkusRuntime = readConfig.getMethodParam(0);

            // TODO - Clean this
            ResultHandle customizer = readConfig.invokeStaticMethod(MethodDescriptor.ofMethod(QuarkusRuntimeConfigSource.class,
                    "customizer", SmallRyeConfigBuilderCustomizer.class, QuarkusRuntime.class), quarkusRuntime);
